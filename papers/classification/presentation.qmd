...
- **Target Type**--Maoist, civilians, security, govt. facility/infrastructure, property, officials, mining co., other amred group, no target
...
- **Encoder Advantage:** Fine-tuned encoders offer good balance of performance, cost, and control
- **Frequency Bias:** Encoders excel at common events but fail on rare, analytically crucial categories
- **Imbalance Solutions:** Standard imbalance handling improves rare category performance
- **Data, Not Models:** Limitations stem from training scarcity and lexical complexity rather than model architecture
