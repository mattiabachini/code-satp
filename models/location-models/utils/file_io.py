...
- Task subdirectory names use hyphenated forms (e.g., "action-type", "target-type", "location-extraction").
...
def get_task_results_dir(task_name: Optional[str], create: bool = True) -> Path:
    """Return the directory for a given task (e.g., "action-type", "location-extraction")."""
